...
async function loadPokemon(id) {
    try {
        ...
        // Clean the data of the previously fetched pokeon
...
// Color background for every pokemon type
const typeColors = {
    normal: "#A8A878",
    fire: "#F08030",
    water: "#6890F0",
...
// Takes an html element and sets the desired cssProperty to a desired value
...
// Transforms a color to translucid
...
function setTypeBackgroundColor(pokemon) {
    ...
    setElementStyles(detailMainElement, "border-color", color);

    setElementsStyles(document.querySelectorAll(".power-wrapper > p"), "background-color", color);
    setElementsStyles(document.querySelectorAll(".stats-wrap p.stats"), "color", color);
    setElementsStyles(document.querySelectorAll(".stats-wrap .progress-bar"), "color", color);
